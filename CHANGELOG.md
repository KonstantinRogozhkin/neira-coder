...
- feat: обновлена версия до 3.31.16
- ui: перемещен AutoApproveMenu (режимы) в самый низ интерфейса для лучшей доступности
- design: улучшена компоновка элементов на главном экране
- ux: режимы теперь отображаются под всеми остальными элементами

### Release Notes

- Улучшена эргономика интерфейса с перемещением режимов в нижнюю часть
- Оптимизирована компоновка элементов на главном экране
- Сохранена полная функциональность всех компонентов

## 3.31.11

### UI Improvements

- feat: обновлена версия до 3.31.11
- tech: восстановлены важные изменения из ветки ui-max-width-v3.31.5
- tech: добавлен подзаголовок "Мультиролевой ИИ для автоматизации рутинных бизнес-задач" в RooHero.tsx
- design: улучшен внешний вид приветственного экрана с описанием возможностей
...
- feat: обновлена версия до 3.31.10
- tech: пересозданы патчи с последними изменениями
- tech: обновлен CHANGELOG.md

### Release Notes

- Подготовка к выпуску версии 3.31.10
- Обновлена документация изменений
...
- feat: обновлена версия до 3.31.9
- fix: исправлены предупреждения линтера в ChatView.tsx
...
- feat: обновлена версия до 3.31.8
- tech: UI improvements with logo subtitle and build instructions

### Release Notes

- Улучшения интерфейса с подзаголовком логотипа
- Обновлены инструкции сборки

## 3.31.7

### UI Improvements

- feat: обновлена версия до 3.31.7
- tech: UI improvements with logo subtitle
...
- feat: обновлена версия до 3.31.6
- tech: Code quality improvements
...
- feat: добавлено ограничение максимальной ширины интерфейса для лучшей читаемости на больших экранах
- design: интерфейс теперь центрируется с боковыми отступами вместо растягивания на всю ширину
- ui: улучшена эргономика при работе в полноэкранном режиме
- ux: оптимальная ширина контента (max-width: 896px) для комфортного чтения

### Technical Updates

- tech: обновлен компонент ChatView с контейнером ограниченной ширины
- tech: обновлен базовый компонент Tab для всех view экранов
- tech: добавлены Tailwind CSS классы для центрирования и ограничения ширины

### Release Notes

- Интерфейс больше не растягивается на весь экран при полноэкранном режиме
- Улучшена читаемость и визуальная эстетика на широких мониторах
- Все view компоненты (Welcome, Settings, Marketplace, MCP, etc.) получили ограничение ширины
- Сохранена полная функциональность интерфейса
...
- tech: updated all UI components with new domain references
- tech: updated GitHub templates with new example URLs
- tech: updated documentation and legal files
- tech: regenerated patches with domain changes
- tech: maintained API endpoints configuration (unchanged)
...
- Patch system updated to include all domain changes
...
- Fix @directory not respecting .rsignore files (thanks @xyOz-dev!)
- Add rsignore checking for insert_content and search_and_replace tools
...
- Add support for a .rsignore to prevent Researcherry from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)

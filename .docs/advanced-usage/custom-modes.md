...
Пользовательские режимы позволяют создавать специализированные "личности" для Researcherry, адаптированные под ваши конкретные потребности и рабочие процессы.

## Что такое пользовательские режимы?

Пользовательские режимы - это настраиваемые конфигурации, которые определяют:

- Как Researcherry отвечает на вопросы

...
Инструменты в Researcherry - это мощные возможности, которые позволяют ИИ-ассистенту взаимодействовать с вашей системой и выполнять реальные действия.

## Что такое инструменты?

Инструменты - это функции, которые Researcherry может выполнять для:
...
Researcherry может читать файлы в вашем проекте:
...
Researcherry может выполнять команды в терминале:
...
MCP позволяет расширять возможности Researcherry неограниченным количеством пользовательских инструментов.

### Что такое MCP?

MCP - это протокол, который позволяет подключать внешние инструменты к Researcherry:
...
Researcherry может комбинировать несколько инструментов:
...
3. Подключите к Researcherry

### Через API

1. Создайте REST API
2. Настройте интеграцию в Researcherry

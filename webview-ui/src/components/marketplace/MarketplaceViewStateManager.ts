 ...
 *
 * This class manages the state for the marketplace view in the Researcherry extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Researcherry extensions interface

...
export default defineConfig(({ mode }) => {
	...
	// TODO: We can use `@researcherry-ai/build` to generate `define` once the
	...
	return {
		...
		resolve: {
			alias: {
				...
				"@neira": resolve(__dirname, "../src/shared"),

...
Пользовательские режимы можно настроить двумя способами:
  ...
  2. Для рабочего пространства через '.neira/.neira-modes' в корневой директории рабочего пространства

Когда режимы с одинаковым slug существуют в обоих файлах, версия .neira-modes для рабочего пространства имеет приоритет. Это позволяет проектам переопределять глобальные режимы или определять режимы, специфичные для проекта.


Если вас просят создать режим проекта, создайте его в .neira/.neira-modes в корне рабочего пространства. Если вас просят создать глобальный режим, используйте глобальный файл пользовательских режимов.

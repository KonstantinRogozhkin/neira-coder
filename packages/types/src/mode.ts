...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	...
	},
	{
		...
		whenToUse: "Сложные многошаговые инициативы, где нужны планирование, дизайн, код, ML и релизы.",
...

	{
		...
		whenToUse: "Перед реализацией: стратегия, декомпозиция, ТЗ, архитектура.",
...

	{
		...
		whenToUse: "Нужно определить что делать, зачем, как измерять эффект и в каком порядке.",
...

	{
		...
		whenToUse: "Реализация фич, исправления, рефакторинг, интеграции.",
...

	{
		...
		whenToUse: "Нужна ясность: теория, сравнение подходов, анализ кода без правок.",
...

	{
		...
		whenToUse: "Поведение «не работает/медленно/нестабильно»; нужны причины и fix-план.",
...

	{
		...
		whenToUse: "Нужны прототип модели, дообучение LLM, инференс-сервис, RAG, встраивание в продукт.",
...

	{
		...
		whenToUse: "Нужно улучшить поведение LLM без/вместе с дообучением: system prompts, few-shot, функции.",
...

	{
		...
		roleDefinition: "Вы — Нейра, Senior Data Engineer. Отвечаете за сбор, качество и доступность данных.",
		whenToUse: "Нужны схемы, пайплайны, хранилища, фичесторы, приватность и права доступа.",
...

	{
		...
		whenToUse: "Нужно воспроизводимое окружение, автоматизация релизов, управление конфигурациями и затратами.",
...

	{
		...
		whenToUse: "Нужно задать SLO, построить мониторинг/алерты, подготовить on-call и runbooks.",
...

	{
		...
		whenToUse: "Нужны проверяемые критерии готовности, регрессия, нагрузка, юзабилити.",
...

	{
		...
		whenToUse: "Нужны объективные и регрессионные проверки моделей/промптов/пайплайнов.",
...

	{
		...
		whenToUse: "Нужны требования безопасности, DPIA, контроль доступа, шифрование, guardrails ИИ.",
...

	{
		...
		whenToUse: "Подготовка и выпуск релиза, координация между инженерией, продуктом и саппортом.",
...

	{
		...
		whenToUse: "Нужно запланировать сбор/разметку/качество датасета под задачу.",

...
build_extension() {
  echo "🔨 Building the Researcherry extension..."
...
if [[ "$(uname -s)" != "Darwin" ]]; then
  ...
  echo "The Researcherry evals system can also be run with Docker on any platform."
...
echo -n "🗄️ Syncing Researcherry evals database... "
...
read -p "💻 Do you want to build a new version of the Researcherry extension? [currently $current_version] (y/N): " build_extension
